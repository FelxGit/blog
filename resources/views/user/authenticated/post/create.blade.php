...
<form action="{{ route('user.post.store') }}" method="POST" role="form">
            @csrf
            @method('POST')
            <div class="box">
              <div class="box-body">
            ...
            <div class="box">
              ...
              <div class="box-body pad {{ $errors->has('body') ? ' is-invalid' : '' }}" id="textarea">
                  ...
                  <textarea id="editor1" class="textarea"  name="body" placeholder="Place some text here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{ old('body') }}</textarea>
              </div>
            </div>
